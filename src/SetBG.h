...
class SetBG {
	public:
	// NOTE: do not change the order of these, they are changed to integer and put on disk.
		enum SetMode {
			SET_SCALE,
			SET_TILE,
			SET_CENTER,
		...
		virtual bool set_bg(Glib::ustring &disp, Glib::ustring file, SetMode mode, Gdk::Color bgcolor, bool flip);
